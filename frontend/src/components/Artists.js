...
const Artists = ({artists, setArtists, setCurrUser}) => {
  ...
  return (
    <>
    <h2 style={{display: 'flex',  justifyContent:'center', alignItems:'center', color:"red"}}> Find new artists! </h2>
